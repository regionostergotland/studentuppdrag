...
Studenter på vårdutbildningar och i högre årskurser på civilingenjörsprogram i medicinsk teknik brukar kunna söka (betalda) [sommarvikariat](https://www.regionostergotland.se/Jobb-och-studier/Lediga-jobb/Sommarvikariat/). Sommarjobb 2022 inom medicisk teknik söks senast 28/2 via epost till Ole.Ronningen@regionostergotland.se. Övriga uppdrag på denna lista är obetald studentpraktik, examensarbeten etc. kopplade till pågående utbildning. Studentuppdrag/praktik för vård-relaterade utbildningar och annonser för vanliga (betalda) arbeten nås via [https://www.regionostergotland.se/Jobb-och-studier/](https://www.regionostergotland.se/Jobb-och-studier/). 

------------------

# Öppna studentuppdrag (nu)

__Designa webbgränssnitt för karta över en organisations informationstillgångar__ (2022)
Alla organisationer behöver ha kontroll över sina informationstillgångar. Det talas ibland om att information, eller data, är den nya oljan. Orsakerna är många, man måste till exempel kunna garantera att informationen hanteras på ett säkert sätt, och för att kunna fatta välgrundade beslut i en komplex verksamhet behövs ofta kunskap om hur olika informationsmängder används, av vem, när och i vilka system. 
Region Östergötland har påbörjat ett arbete med att kartlägga sina informationstillgångar. Tanken är att man ska kunna se vilken information som lagras var, hur den relaterar till annan information, vem som ansvarar för den, vilka lagkrav och externa standarder som är knutna till den, vilka verksamhetsprocesser den ingår i, osv. Kartläggningen dokumenteras i ett modelleringsverktyg och det är möjligt att exportera resultatet i html-format. Problemet är att det inte blir speciellt lättanvänt för någon. Ett bättre publiceringsformat som möter de olika målgruppernas behov behövs, annars kommer delar av den önskade nyttan av kartläggningen att utebli. Studentprojektet handlar om att ta fram ett eller flera designförslag för ett webbaserat användargränssnitt, i vilket det ska vara möjligt att navigera runt i den så kallade informationskartan utifrån olika perspektiv. En utmaning är att hitta generella mönster som håller när den underliggande kartan utökas med nya informationsdomäner, en annan att kunna presentera informationen på olika sätt beroende på vilket syfte användaren har.

__Jämföra designansatser vid utveckling av beställningssystem__ (våren 2022)
Region Östergötlands it-avdelning sköter om regionens it-miljö. I detta ingår även viss egenutveckling av system. Ett egenutvecklat system är det beställningssystem där regionanställda kan beställa it-utrustning. Systemet är gammalt och man har nu beslutat att ersätta systemet genom att utveckla ett nytt som ska göra det enklare för användare att lägga beställningar. Fokus är således på beställarrollen. 
Utvecklingsenheten i Region Östergötland vill jobba med användarorienterade metoder i utveckling och design men är endast i början av resan mot en etablerad användarorienterad utvecklingsmetodik och -process. Studentprojektet går ut på att ta sig an samma designuppgift som det pågående projektet Nytt beställningssystem, och i ett parallellt designspår påvisa hur man med olika metodansatser kan uppnå olika typer av resultat. I detta kan ingå att även inkludera RÖ:s nuvarande arbetssätt i jämförelsen. Arbetet innefattar stegen från behovsanalys till prototyp. Ett alternativt upplägg för studentprojektet skulle kunna vara att, i stället för att titta på beställarrollen (som är fokus för det påbörjade projektet), utforska användargruppen beställningsmottagare.

__"Low/no Code" för att ersätta eller komplettera "vanlig" programmering:__ (Höst 2021)
...
__Miljö och klimat__ Hör av dig med en ansökan om du har intresse av området. Exempel på tidigare studentuppdrag:
